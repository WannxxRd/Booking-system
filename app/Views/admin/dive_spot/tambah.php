...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-2 mb-4"><span class="text-muted fw-light">Data Dive Spot /</span> Tambah</h4>

    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Tambah Data Dive Spot</h5>
                </div>
                <div class="card-body">

                    <form action="<?= base_url('admin/dive_spot/tambah/' . $cluster_id) ?>" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_dive_spot" name="nama_dive_spot" value="<?= old('nama_dive_spot') ?>" required />
                            </div>
                        </div>
                        <div class="row mb-3">
