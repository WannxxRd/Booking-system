...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-2 mb-4"><span class="text-muted fw-light">Data Jam /</span> Tambah</h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/jam/tambah') ?>" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_jam" name="nama_jam" value="<?= old('nama_jam') ?>" required />
                            </div>
                        </div>
                        <hr>
                        <div class="row">
