...
class Riwayat extends BaseController
{
    ...
    {
        $registrasi = $this->registrasiModel->find($id);

        if (!empty($registrasi['dokumen']) && file_exists(FCPATH . 'uploads/dokumen/' . $registrasi['dokumen'])) {
            unlink(FCPATH . 'uploads/dokumen/' . $registrasi['dokumen']);
        }

        $result = $this->registrasiModel->delete($id);
